        ...
        <div class="text-center">
            ...
            <div class="max-w-3xl mx-auto">
                    ...
                    <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                        <div class="flex-1">
                            <input type="text" name="search" placeholder="Job title, keywords, or company" 
                                   class="w-full px-6 py-4 text-gray-900 rounded-lg border-0 focus:ring-2 focus:ring-indigo-500 text-lg">
                        </div>
                        <div class="flex-1">
                        ...
                        <button type="submit" 
                                class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-4 rounded-lg font-bold text-lg hover:from-indigo-700 hover:to-purple-700 transition duration-300 whitespace-nowrap">
                            Search Jobs
                        </button>
                    </div>
                </form>
                ...
                <div class="mt-6 flex flex-wrap justify-center gap-4">
                    <span class="text-white opacity-80">Popular Searches:</span>
                    <a href="{{ route('jobs.index') }}?search=developer" class="bg-white bg-opacity-20 backdrop-blur-sm px-4 py-2 rounded-full hover:bg-opacity-30 transition">Developer</a>
                    <a href="{{ route('jobs.index') }}?search=designer" class="bg-white bg-opacity-20 backdrop-blur-sm px-4 py-2 rounded-full hover:bg-opacity-30 transition">Designer</a>
                    <a href="{{ route('jobs.index') }}?search=marketing" class="bg-white bg-opacity-20 backdrop-blur-sm px-4 py-2 rounded-full hover:bg-opacity-30 transition">Marketing</a>
                    <a href="{{ route('jobs.index') }}?job_type=remote" class="bg-white bg-opacity-20 backdrop-blur-sm px-4 py-2 rounded-full hover:bg-opacity-30 transition">Remote</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="p-6">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            @else
                                <div class="w-14 h-14 bg-gradient-to-r from-indigo-100 to-purple-100 rounded-xl flex items-center justify-center">
                                    <span class="text-2xl font-bold text-indigo-600">{{ substr($job->company_name, 0, 1) }}</span>
                                </div>
                            @endif
                            <div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex space-x-2">
                            <span class="bg-blue-100 text-blue-800 text-xs px-3 py-1 rounded-full">{{ $job->experience_level }}</span>
                            <span class="bg-purple-100 text-purple-800 text-xs px-3 py-1 rounded-full">{{ $job->job_type }}</span>
                        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            ...
            <a href="{{ route('jobs.index') }}?search={{ $category['title'] }}" 
               class="group p-6 bg-gray-50 rounded-xl hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 transition duration-300 border border-gray-200 hover:border-indigo-200 text-center">
                <div class="text-3xl mb-3 group-hover:scale-110 transition-transform duration-300">{{ $category['icon'] }}</div>
...
<div class="py-16 bg-gradient-to-r from-gray-50 to-indigo-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center">
                <div class="w-20 h-20 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-6 text-white text-2xl font-bold">
                    1
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <x-card class="p-6 hover:shadow-xl transition-shadow duration-300">
                <div class="flex items-center mb-4">
                    <div class="w-12 h-12 bg-gradient-to-r from-blue-100 to-cyan-100 rounded-full flex items-center justify-center text-blue-600 font-bold text-xl mr-4">
                        S
                    </div>
                    <div>
                ...
                <p class="text-gray-600 italic">"Found my dream job within 2 weeks of joining JobPortal. The platform made it so easy to connect with top tech companies!"</p>
            ...
            <x-card class="p-6 hover:shadow-xl transition-shadow duration-300">
                <div class="flex items-center mb-4">
                    <div class="w-12 h-12 bg-gradient-to-r from-green-100 to-emerald-100 rounded-full flex items-center justify-center text-green-600 font-bold text-xl mr-4">
                        M
                    </div>
                    <div>
                ...
                <p class="text-gray-600 italic">"The quality of job listings is exceptional. I received interview requests from companies I never thought would notice me."</p>
                <div class="flex text-yellow-400 mt-4">
                    ★★★★★
                </div>
            </x-card>
            ...
            <x-card class="p-6 hover:shadow-xl transition-shadow duration-300">
                <div class="flex items-center mb-4">
                    <div class="w-12 h-12 bg-gradient-to-r from-purple-100 to-pink-100 rounded-full flex items-center justify-center text-purple-600 font-bold text-xl mr-4">
                        R
                    </div>
                    <div>
                ...
                <p class="text-gray-600 italic">"As an employer, JobPortal helped me find the perfect candidates. The matching algorithm is spot on!"</p>
                <div class="flex text-yellow-400 mt-4">
                    ★★★★★
                </div>
            </x-card>
...
<div class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl opacity-90 mb-8">Join thousands of professionals who have found their perfect career match</p>
