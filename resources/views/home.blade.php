...
@section('content')
    ...
    <div class="relative h-screen flex items-center justify-center hero-bg overflow-hidden">
        <!-- Animated Gradient Background Shapes - Fixed positioning -->
        <div
            class="absolute w-72 h-72 md:w-96 md:h-96 rounded-full bg-gradient-to-r from-emerald-400 to-cyan-400 opacity-20 animate-pulse-slow top-0 left-0 -translate-x-1/3 -translate-y-1/3">
        </div>
        <div
            class="absolute w-72 h-72 md:w-96 md:h-96 rounded-full bg-gradient-to-r from-pink-400 to-purple-500 opacity-30 animate-pulse-slow bottom-0 right-0 translate-x-1/3 translate-y-1/3">
        </div>

        <div class="relative text-center px-4 max-w-3xl z-10">
            <h1 class="text-4xl md:text-5xl lg:text-7xl font-extrabold text-blue-600 mb-6 animate-gradient-text">
                Find Your <span class="bg-clip-text text-transparent bg-gradient-to-r from-emerald-300 to-cyan-300">Dream
                    Career</span>
            </h1>
            <p class="text-base md:text-lg lg:text-xl text-blue-400 mb-8 md:mb-10 animate-fade-in-up delay-200">
                Connect with top employers and discover thousands of opportunities tailored to your skills.
            </p>

            <!-- Search Box -->
            <form action="#" method="GET" class="flex flex-col md:flex-row gap-3 animate-fade-in-up delay-400">
                <input type="text" name="search" placeholder="Job Title, Keywords, Category"
                    class="flex-1 px-4 md:px-6 py-3 md:py-4 rounded-xl shadow-lg focus:ring-2 focus:ring-cyan-400 focus:outline-none text-base md:text-lg placeholder-gray-400 bg-white/90 backdrop-blur-sm transition-all duration-300">
                <button type="submit"
                    class="px-8 md:px-10 py-3 md:py-4 bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white font-bold rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                    <i class="fas fa-search mr-2"></i> Search Jobs
                </button>
            </form>
        </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    @foreach ($categories as $category)
                        <a href="{{ route('jobs.index', ['category' => $category->id]) }}"
                            ...
                            <h3 class="text-xl font-bold text-blue-600 mb-2 group-hover:text-blue-700">{{ $category->name }}
                            </h3>
        ...
        <div class="container mx-auto px-4">
            ...
            @if ($featuredJobs->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach ($featuredJobs as $job)
                        <div
                            class="group relative bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-blue-200 hover:-translate-y-1">
                            <!-- Job Type Badge -->
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-start gap-4 mb-5">
                                    <div class="flex-shrink-0">
                                        <div
                                            class="w-12 h-12 rounded-lg bg-gradient-to-br from-blue-50 to-purple-100 flex items-center justify-center group-hover:scale-105 transition-transform duration-300">
                                            @if ($job->company_logo)
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h3
                                            class="text-lg font-bold text-gray-900 truncate group-hover:text-blue-700 transition-colors">
                                            <a href="{{ route('jobs.show', $job) }}"
                                                class="hover:underline">{{ $job->title }}</a>
                                        </h3>
                                        <p class="text-sm font-medium text-gray-700 mt-1">
                                            {{ $job->company ? $job->company->name : $job->company_name ?? '' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-3 mb-6">
                                            ...
                                            @elseif($job->salary_min && $job->salary_max)
                                                @php
                                                    ...
                                                    if ($job->salary_currency == 'EUR') {
                                                        $currencySymbol = '€';
                                                    } elseif ($job->salary_currency == 'GBP') {
                                                        $currencySymbol = '£';
                                                    } elseif ($job->salary_currency == 'BDT') {
                                                        $currencySymbol = '৳';
                                    ...
                                    @if (!empty($skills))
                                        <div class="flex flex-wrap gap-1.5 pt-2">
                                            ...
                                            @if (count($skills) > 3)
                                                <span
                                                    class="inline-block px-2 py-1 bg-gray-100 text-gray-500 text-xs rounded-md">
                                                    +{{ count($skills) - 3 }} more
                                                </span>
                                            @endif
                                        </div>
                                ...
                                <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                    ...
                                    <a href="{{ route('jobs.show', $job) }}"
                                        ...
                                        Apply Now
                                        <svg class="w-3.5 h-3.5 ml-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            @else
                ...
                <div class="max-w-md mx-auto text-center py-12">
                    <div
                        class="w-20 h-20 mx-auto mb-6 rounded-full bg-gradient-to-r from-gray-100 to-gray-200 flex items-center justify-center">
        ...
        <div class="relative max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                <div class="bg-white/10 backdrop-blur rounded-lg p-10 text-center hover:bg-white/15 transition">
                    <div
                        class="w-16 h-16 mx-auto mb-6 flex items-center justify-center rounded-full border border-white/30">
                        {{-- Icon --}}
                                ...
                                @php
                                    $testimonials = [
                                        [
                                            ...
                                            'content' =>
                                                "Found my perfect remote role within 2 weeks! The platform's filters helped me target exactly what I was looking for. The application process was seamless.",
                                        ...
                                        [
                                            ...
                                            'content' =>
                                                'After months of searching, I landed my dream job through this portal. The quality of job listings and the responsiveness of employers exceeded my expectations.',
                                            'avatar' => 'testimonial-founder.png',
                                        ],
                                        [
                                            'name' => 'Emma Wilson',
                                            ...
                                            'content' =>
                                                'The resume builder and profile features helped me stand out. I received interview requests from 5 companies within the first week of joining.',
                                            'avatar' => 'testimonial-founder.png',
                                        ],
                                        [
                                            ...
                                            'content' =>
                                                'As a data scientist, finding the right role was challenging. This platform matched me with companies that truly valued my skills. Got hired within a month!',
                                            'avatar' => 'testimonial-founder.png',
                                        ],
                                        [
                                            'name' => 'Lisa Thompson',
                                            ...
                                            'company' => 'StartUpHub',
                                            'content' =>
                                                'The job recommendations were spot on. I found a startup that perfectly matched my career goals. The entire process was smooth and professional.',
                                            'avatar' => 'testimonial-founder.png',
                                        ],
                                        [
                                            'name' => 'James Wilson',
                                            ...
                                            'content' =>
                                                'Transitioning to DevOps was made easy with this platform. The relevant job alerts and company profiles helped me make an informed decision.',
                                            'avatar' => 'testimonial-founder.png',
                                        ],
                                    ];
                                @endphp
    ...
    <div class="relative py-28 overflow-hidden">
        ...
        <!-- Animated Elements -->
        <div
            class="absolute top-0 left-0 w-64 h-64 bg-gradient-to-br from-white/5 to-transparent rounded-full -translate-x-1/2 -translate-y-1/2">
        </div>
        <div
            class="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-white/5 to-transparent rounded-full translate-x-1/3 translate-y-1/3">
        </div>
        ...
        <div class="relative container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <h2 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                    Launch Your
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 to-cyan-300">Dream
                        Career</span>
                    Today
                </h2>
                ...
                <p class="text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
                    Join thousands of professionals who found their perfect match. Upload your resume and let AI-powered
                    matching connect you with top employers.
                </p>
                    ...
                    @auth
                        @if (auth()->user()->isJobSeeker())
                            <a href="{{ route('job-seeker.professional-profile.edit') }}"
                                ...
                                <div
                                    class="absolute inset-0 bg-gradient-to-r from-white/0 to-white/5 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                </div>
        ...
        <section class="py-12 bg-gradient-to-b from-gray-50 to-white">
            <div class="container mx-auto px-4">
                <div class="text-center mb-10">
                    ...
                    <p class="text-gray-600 max-w-2xl mx-auto">Stay updated with career advice, industry trends, and job
                        search tips from our experts.</p>
                </div>
                    ...
                    @foreach ($featuredBlogs as $blog)
                        <div class="bg-white overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group">
                            <div class="relative overflow-hidden">
                                ...
                                @else
                                    <div
                                        class="w-full h-56 bg-gradient-to-r from-blue-100 to-indigo-100 flex items-center justify-center">
                            ...
                            <div class="p-8">
                                <div class="flex items-center text-sm text-gray-500 mb-4">
                                    <span
                                        class="bg-[#BDE8F5] text-[#1C4D8D] px-3 py-1 rounded-full text-xs font-medium mr-3">
                                ...
                                <h3
                                    class="text-2xl font-bold text-gray-900 mb-4 group-hover:text-[#1C4D8D] transition-colors">
